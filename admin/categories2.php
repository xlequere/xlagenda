...
if ($authorised == 1)
{
	...
	<h3>".$lang['admin_title_nouvelle_categorie']."</h3>
	<p>
	<label for=\"nom\">".$lang['admin_label_nom_categorie']."</label><br />
	<input name=\"nom\" type=\"text\" id=\"nom\" value=\"\" onkeyup=\"checkCategorie()\" /> <span id=\"divCategorie\"></span>
	</p>
	<p>".
	$lang['admin_label_categorie_active']."<br />
	<input type=\"radio\" name=\"actif\" value=\"1\" checked=\"checked\" />".$lang['admin_oui']."
	<input type=\"radio\" name=\"actif\" value=\"0\" />".$lang['admin_non']."
	</p>
	<p> 
